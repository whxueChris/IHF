...
# 设置路径
input_folder = './interpolation_pixel_friction/txt_clean_test1'
output_folder = './interpolation_pixel_friction/txt_clean_resample_test1'
...
for filename in sorted_txt_files:
    ...
    np.savetxt(output_path2, np.column_stack((x_new, y_new2)), delimiter=',',fmt='%.4f')
...
generate_heatmap_resample_data(
    ...
    output_image=os.path.join(output_folder, 'stacked_heatmap_elephant.png')
)
